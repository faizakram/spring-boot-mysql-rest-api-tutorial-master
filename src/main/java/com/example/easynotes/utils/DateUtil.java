...
public class DateUtil {
	...
	private static Date convertDateToAnotherTimeZone(Date inputDate, String inputTimezoneCode,
		...
		DateFormat df = new SimpleDateFormat(ConfigurationConstant.SIMPLE_DATE_TIME_FORMAT_VALUE);
		df.format(newDate);
	...
	public static Timestamp getCurrentTimestampInUTC() {
		...
		Date currentUtcDate = convertDateToAnotherTimeZone(new Date(), defaultTimeZone, ConfigurationConstant.UTC_TIME_ZONE);
	...
	public static String getDayOfTheDate(String date) throws ParseException {
		Date formatedDate = new SimpleDateFormat(ConfigurationConstant.SIMPLE_DATE_FORMAT_VALUE).parse(date);
	...
	public static Map<String, Integer> getDateDiff(String date) {
		...
		DateTimeFormatter formatter = DateTimeFormatter.ofPattern(ConfigurationConstant.SIMPLE_DATE_FORMAT_VALUE);
		LocalDate pdate = LocalDate.parse(date, formatter);
		LocalDate now = LocalDate.now(ZoneOffset.UTC);
		Period diff = Period.between(pdate, now);
		dateMap.put(ConfigurationConstant.DAYS, diff.getDays());
		dateMap.put(ConfigurationConstant.MONTHS, diff.getMonths());
		dateMap.put(ConfigurationConstant.YEARS, diff.getYears());
		return dateMap;
	}
	...
	public static LocalDate addDayMonthYear(Map<String, Integer> dateMap) {
		...
		date = date.plusDays(dateMap.get(ConfigurationConstant.DAYS));
		date = date.plusMonths(dateMap.get(ConfigurationConstant.MONTHS));
		date = date.plusMonths(dateMap.get(ConfigurationConstant.YEARS));
		return date;
	}
	 ...
	 * @return
	 */
	public static Date addMinToCurrentUTC(int mins) {
