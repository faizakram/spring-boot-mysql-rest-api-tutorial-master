...
import com.example.easynotes.utils.PDFGenerator;
...
public class DownloadPDFReportController {
	...
	public StreamingResponseBody downloadThumbnail(HttpServletResponse httpResponse) {
		DownloadFile downloadFile = new DownloadFile("abc.pdf",
				PDFGenerator.generatePDFContentFromHTML(getContentFromTemplate("E:\\Websites\\Wildfly-SparksLinkDEVAPI\\standalone\\SparksLink\\mail_templates\\inventory-report.html")).toByteArray());
